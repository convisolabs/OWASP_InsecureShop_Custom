...
class LoginActivity : AppCompatActivity() {
    ...
    // Vulnerabilidade - Não há verificação se o dispositivo permite acesso a diretórios privados usando o comando SU, por exemplo
    ...
    fun onLogin(view: View) {
        ...
        if (auth) {
            // Vulnerabilidade - Guarda credenciais em SharedPreferences sem criptografia
